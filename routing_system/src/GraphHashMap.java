...
public class GraphHashMap {
    ...
    public void print(Object source, Object destination, String path, boolean[] visited) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (indexes.get(edge.destination) < adjacencyList.size() && edge.destination != destination
                    && visited[indexes.get(edge.destination)] == false) {
    ...
    public void getShortestPath() {
        ...
        System.out.println("Actual Shortest Path with a distance of " + smallest + " meters : "
                + String.join(" -> ", allPaths.get(index)));
    }
